...
export const BeachDetailPage: React.FC<BeachDetailPageProps> = ({
  ...
  const submitFeedback = (verdict: ConditionFeedbackVerdict, observedTiming?: ObservedTiming) => {
    ...
    storeConditionFeedback(committedBeachId, verdict, {
      ...
      // μέρα και κάνει το σχόλιο να μοιάζει συγκρίσιμο ενώ δεν είναι. Ο διακόπτης της μέρας
      // είναι το μόνο σημείο που ξέρει την απάντηση χωρίς εικασίες για ζώνη ώρας: το `date`
      // βγαίνει από το ρολόι ΤΗΣ ΣΥΣΚΕΥΗΣ, οπότε ένας δέκτης σε ώρα Ελλάδας θα το έκρινε λάθος
      // για επισκέπτη στο εξωτερικό — γι' αυτό φεύγει ως σημαία, όχι ως σύγκριση ημερομηνιών.
      selectedDayIsToday,
    }, {
