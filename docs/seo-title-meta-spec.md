...
2. **Story opener + live CTA**: πρώτη «safe» παράγραφος του editorial story,
   ...
   **06/09/2026 — το CTA προηγείται του μήκους του opener**: δοκιμάζονται ΟΛΑ τα
   σκαλιά κοπής (115→100→85→70) ΜΕ το CTA πρώτα, και μόνο αν δεν χωράει πουθενά
   πέφτει το CTA. Η παλιά σειρά (withCta→withoutCta στο ίδιο σκαλί) έριχνε το CTA
   ακριβώς στις διάσημες παραλίες με μεγάλα stories (Kathisma, Vrasidas, Elia) —
   δηλαδή εκεί που μαζεύονταν οι περισσότερες εμφανίσεις χωρίς κλικ.
