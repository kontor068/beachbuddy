...
4. **Swell validation**: 3 ιστορικές ημέρες Ιονίου με γνωστή SW ρεστία και ασθενή άνεμο
   ...
   **R1 FOLLOW-UP (εγκρίθηκε 2026-06-12 από Miltos, εκτελείται στο R2)**: το R1 live τεστ
   έπιασε ΒΔ event (310-315°), όχι το σχεδιασμένο ΝΔ ιστορικό — τα 3 W/NW-facing targets
   φλέγκαραν σωστά αλλά σε ΒΔ. Στο R2 validation πρόσθεσε `past_days` run με ΓΝΗΣΙΟ ΝΔ
   (220-250°) swell event (ψάξε στο παρελθόν ώστε swell_wave_direction στο 220-250 & ύψος
   ≥0.7m) ώστε να επιβεβαιωθεί το αρχικό 2δ-4 στο σχεδιασμένο καθεστώς· τα Mod-2 closed-bay
   (Λίμνη Βουλιαγμένης #20, Avra Αίγινας #83) πρέπει να μένουν no-flag και σε αυτό.
