...
Τύπος (SPM 1984/Saville· σημειώνεται ότι κυκλοφορούν παραλλαγές — δεσμευόμαστε σε αυτή):
...
ανέμου (κέντρο τομέα στο build· η runtime παρεμβολή μένει ως έχει). Ένα cos προβάλλει το
radial στη διεύθυνση ανέμου, το δεύτερο σταθμίζει το directional spreading· ο παρονομαστής
Σcos κανονικοποιεί ώστε ομοιόμορφα ανοιχτή θάλασσα να δίνει F_eff = x.
...
den = Σ cos(θ_i)                                  # σταθερά ≈ 13.50 για το FAN_V2
effectiveFetchKm = num / den
