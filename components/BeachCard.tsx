...
const BeachCardImpl: React.FC<BeachCardProps> = ({
   ...
   * εκεί που κάποιος το ζήτησε: το ταμπελάκι της πινέζας τυπώνει «λέξη · νούμερο» για τον ΑΝΕΜΟ
   * (για το κύμα, από 25/08 μόνο τη λέξη — BeachMap),
        ...
        >
          ...
          {cardPhoto ? (
            <img
              ...
              className="absolute inset-0 h-full w-full beach-photo-frame transition-transform duration-700 group-hover:scale-[1.03]"
              width={640}
              height={360}
