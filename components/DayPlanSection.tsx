          ...
          return (
            <li key={stop.slot}>
              <Wrapper
                ...
                className={`flex w-full items-center gap-3 rounded-control border border-line bg-surface px-3 py-2.5 text-left ${interactive ? 'transition-colors hover:bg-slate-50' : ''}`}
              >
                <div className={`flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-control text-white ${SLOT_TONE[stop.slot]}`}>
