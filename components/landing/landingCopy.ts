...
export const landingCopy: Record<LanguageCode, LandingCopy> = {
  gr: {
    ...
    today: {
      ...
      //
      // «ΕΝΔΕΙΚΤΙΚΑ» ΠΡΟΣΤΕΘΗΚΕ 30/08/2026 (Μίλτος: πες κάπου ότι δεν είναι μόνο αυτές οι
      // περιοχές). Το «ή δες όλες τις περιοχές» κάτω από τα πλακίδια το λέει ήδη, αλλά είναι
      // μετά από ολόκληρο το πλέγμα — όποιος δεν κατεβάσει τη σελίδα ως εκεί μπορεί να διαβάσει
      // τα 13 πλακίδια σαν να είναι όλη η Ελλάδα. Μία λέξη εδώ, στην πρώτη πρόταση που βλέπει,
      // το διορθώνει χωρίς να ξαναγράφει τη δεύτερη πρόταση (που κρατάει την υπόσχεση του ανέμου).
      subtitle: 'Αυτές ψάχνουν πιο πολύ οι επισκέπτες μας, ενδεικτικά. Μπες σε μία και δες πού φυσάει σήμερα.',
      ...
      // ΙΔΙΑ ΔΟΜΗ ΜΕ ΤΟ shelterSubtitle ΑΠΟ ΠΑΝΩ (30/08/2026, Μίλτος: «αυτό δεν μου αρέσει»).
      // Η παλιά διατύπωση («αλλάζει από περιοχή σε περιοχή» / «προστατεύονται σε καθεμιά»)
      // επαναλάμβανε «περιοχή» δύο φορές σερί στην πρώτη πρόταση και μετά κρεμούσε ένα «καθεμιά»
      // χωρίς ξεκάθαρο υποκείμενο να δείχνει. Εδώ ξαναχρησιμοποιείται το ίδιο «παραλίες κάθε
      // περιοχής είναι προστατευμένες» με το αδερφάκι της, οπότε ο αναγνώστης βλέπει την ίδια
      // πρόταση και στις δύο περιπτώσεις — μόνο το πρώτο μισό αλλάζει.
      shelterSubtitleMixed: 'Σήμερα ο άνεμος αλλάζει ανά περιοχή. Ο αριθμός δείχνει πόσες παραλίες κάθε περιοχής είναι προστατευμένες σήμερα.',
