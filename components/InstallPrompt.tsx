...
const COPY: LocalizedCopy<Copy> = {
  en: {
    ...
    iosGuideIntro: 'In Safari, install CalmBeach in three quick steps.',
  ...
  gr: {
    ...
    iosGuideIntro: '\\u03a3\\u03c4\\u03bf Safari, \\u03b5\\u03b3\\u03ba\\u03b1\\u03c4\\u03ad\\u03c3\\u03c4\\u03b7\\u03c3\\u03b5 \\u03c4\\u03bf CalmBeach \\u03c3\\u03b5 3 \\u03b3\\u03c1\\u03ae\\u03b3\\u03bf\\u03c1\\u03b1 \\u03b2\\u03ae\\u03bc\\u03b1\\u03c4\\u03b1.',
    ...
    back: '\\u03a0\\u03af\\u03c3\\u03c9',
    title: 'Εγκατάστησε το CalmBeach',
  ...
  fr: {
    ...
    iosGuideIntro: 'Dans Safari, installez CalmBeach en trois \\u00e9tapes.',
  ...
  de: {
    ...
    iosGuideIntro: 'Installiere CalmBeach in Safari in drei Schritten.',
  ...
  it: {
    ...
    iosGuideIntro: 'In Safari, installa CalmBeach in tre passaggi.',
