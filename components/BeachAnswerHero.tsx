 ...
 *
 * ΤΙ ΚΟΣΤΙΣΕ, ΡΗΤΑ: στα 4-5 Μπφ η υπήνεμη και η πλάγια ακτή διαβάζονται πλέον ΙΔΙΑ σε αυτό το
 * πλακίδιο. Η προστασία δεν χάνεται από τη σελίδα — τη λένε το διπλανό πλακίδιο («~0,1 μ.»
 * δίπλα σε «0,3 μ. ανοιχτά»), το χρώμα του κελύφους, το τσιπάκι «Πιο προστατευμένη» της
 * κάρτας και η στατική ενότητα του τοπικού ανέμου. Αυτό που χάνεται είναι μια ΥΠΟΣΧΕΣΗ
 * νηνεμίας που δεν την υπολογίζουμε: εμείς μετράμε τη σκιά στο ΚΥΜΑ, όχι πόσα μποφόρ λιγότερα
 * πέφτουν στην άμμο. Το «κατάμουτρα» μένει σε κάθε ένταση — δεν υπόσχεται τίποτα και λέει
 * κάτι που ο αριθμός δεν λέει.
 *
 * ΜΟΝΟΔΡΟΜΗ, ΟΠΩΣ ΟΛΕΣ: η κλίμακα μπορεί μόνο να αφαιρέσει ηρεμία. «Απάνεμη» και «αεράκι»
 * επιβιώνουν ΜΟΝΟ στα 3 Μπφ (SHELTER_WORD_CALM_PROMISE_MAX_BEAUFORT), όπου η κάρτα λέει
 * «Λίγος αέρας» και οι δύο επιφάνειες δεν διαφωνούν. Αριθμός, χρώμα, ετυμηγορία, κατάταξη:
 * αμετάβλητα — αλλάζει μία λέξη σε ένα πλακίδιο.
 *
