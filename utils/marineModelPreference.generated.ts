 ...
 * το ewam κερδίζει παντού επειδή μετρήθηκε καλύτερο σε 9.723 ώρες σημαδούρας, ΑΛΛΑ σε 49
 * σημεία το κελί του περιγράφει νερό που η παραλία δεν βλέπει ενώ του meteofrance_wave όχι.
 * Οι 12 περιπτώσεις όπου το meteofrance θα έχανε τη διάκριση των δύο ακτών ΔΕΝ μπαίνουν εδώ.
 */
...
export const MARINE_MODEL_PREFERENCE_SKIPPED = 12;
