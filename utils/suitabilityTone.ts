...
export const resolveConditionTone = ({
  ...
  downwindSeaSample,
  seaArrivalExposureLevel,
  // curatedWindOnlyProtection: ΕΚΛΕΙΣΕ 10/09/2026 (βίβλος §Γ74, εύρημα του ελέγχου στο §Γ25).
  // Ως τότε εδώ περνούσε `undefined` — προϋπάρχον κενό, σημειωμένο αλλά αδιόρθωτο στο §Γ71 — και
  // ο επιθεωρημένος «μόνο-για-άνεμο» όρμος έπαιρνε στο ΤΑΒΑΝΙ την έκπτωση κύματος που το §Γ25
  // υποσχέθηκε ότι δεν παίρνει: στα 3-4 και 6-7 Μποφόρ με θάλασσα ~1 μ. η κάρτα έβγαινε ένα
  // σκαλί πιο ήπια από την πινέζα. Τώρα το ταβάνι βλέπει την ίδια σημαία με το δάπεδο και την
  // πόρτα (γρ. πιο πάνω). Μόνο προς την προσοχή· στα ακριβώς 5 Μποφόρ η εξαίρεση όρμου ισχύει ως έχει.
