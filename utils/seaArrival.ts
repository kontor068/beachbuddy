 ...
 *
 * +17 ΤΗΝ ΙΔΙΑ ΜΕΡΑ, ΜΕ ΤΟΝ ΔΕΥΤΕΡΟ ΚΡΙΤΗ (reports/quality/shadow-second-judge.json, 10/09): ο
 * Copernicus ρωτήθηκε για τις 23 «βαθιές σκιές» στο ΙΔΙΟ ωριαίο βήμα της 16/08 (16:00 UTC). Σε 17
 * βλέπει κι αυτός ≥0,5 μ. (0,50–1,98) εκεί που τυπώναμε 0,05–0,29 → δύο μοντέλα, όπως οι τέσσερις
 * πάνω. Οι 6 όπου ο κριτής δίνει <0,5 (Ρίχτης #2231, Σκάλα #1071, Αγ. Ιωάννης #1446, Κιμηλιά #1069,
 * Νότος #817, Αμίδι #1062) ΔΕΝ μπαίνουν: εκεί η σκιά μπορεί να είναι αληθινή.
 */
export const JUDGE_WITNESSED_ARRIVAL_BEACH_IDS: ReadonlySet<number> = new Set([
  2009, 1428, 2189, 1696,
  2191, 1284, 1662, 1668, 1257, 2106, 543, 1880, 1864, 611, 2501, 2361, 2363, 2226, 2662, 2148, 160,
]);
