...
/**
 * ⚠️ ΤΟ 0,25 ΔΟΚΙΜΑΣΤΗΚΕ ΚΑΙ ΚΟΠΗΚΕ (13/09/2026, βίβλος §Γ81 Δ7-Β) — μην το ξαναπροτείνεις χωρίς τους μάρτυρες.
 * Ο δορυφόρος (Δ7, 30.513 παραλιο-μέρες) λέει ότι εκεί που η γεωμετρία δίνει 0,1 η άμμος αφρίζει σαν ~0,29, και το
 * δάπεδο 0,25 μετρήθηκε εθνικά (scripts/measureShadowKdFloor.mjs: αγγίζει ΜΟΝΟ το τυπωμένο νούμερο, ορατό σε
 * 344/309 παραλίες, ετυμηγορία 0, χρώμα 0) και μπήκε σε commit. Το έκοψε η πύλη shore-shadow-witnesses: η Λίνδος
 * #2443 (τσέπη, κάμερα 29/08: λάδι με λουόμενους σε 1,1 μ. ανοιχτά) θα τύπωνε 0,28 μ. «Σχεδόν χωρίς κύμα»· Πρέβελη,
 * Κουκουναριές, Γέρακας (η θάλασσα ΦΕΥΓΕΙ) και ο Μώλος από νοτιά θα έχαναν τη βαθιά σκιά. Γιατί διαφωνούν οι δύο
 * κριτές: ο δορυφόρος βλέπει ΑΦΡΟ (~0,4 μ.+) και είναι τυφλός ανάμεσα σε 0,1 και 0,3 μ. — ακριβώς εκεί που θα έγραφε
 * το δάπεδο· οι κάμερες βλέπουν το λάδι. Το «2,5× ρηχότερη» είναι μέσος όρος που ανακατεύει τσέπες, κλειστούς
 * κύκλους, θάλασσα που φεύγει και γωνίες 95°+ — δεν λέει ΠΟΥ. Δρόμος: Δ11 (δύο K_d — η ρεστία στρίβει
 * περισσότερο) ή K_d με περίοδο, μετρημένο ΚΑΙ στους 7 μάρτυρες ΚΑΙ στον δορυφόρο μαζί.
 */
 ...
 *
 * ⚠️ ΑΝΑΤΡΟΠΗ ΤΟ ΙΔΙΟ ΒΡΑΔΥ (10/09/2026, βίβλος §Γ75 — ΑΠΟΦΑΣΗ ΜΙΛΤΟΥ «Α»). Ο «κριτής» όλων των
 * παραπάνω ήταν δύο μοντέλα με κελί 4-5 χλμ.: βλέπουν την ανοιχτή θάλασσα, όχι την άμμο (το decision
 * log 23/08 το είχε ήδη γράψει). Ένα τρίτο βήμα της ίδιας μέρας είχε προσθέσει +17 με τον ίδιο κριτή
 * (reports/quality/shadow-second-judge.json) — δεν ανέβηκε ποτέ. Ο κριτής ΣΤΗΝ ΑΜΜΟ (Sentinel-2 10 μ.,
 * αφρός θραύσης, scripts/judgeShoreSurfSentinel2.py) είδε ότι η βαθιά σκιά είναι ΑΛΗΘΙΝΗ:
 *   Μουτσούνα #2009 — αφρός 0,02 σε 17 καθαρές μέρες βοριά (1,1-2,2 μ. έξω) έναντι 0,16 σε ανοιχτές·
 *   Φράγκου #1428   — 0,015 σε 16 μέρες βοριά έναντι 0,33 σε 7 ανοιχτές·
 *   και από τις +17 όπου κρίθηκαν (Λιμενάρι #2191, Ψιλή #1284, Χόχλακας #1668) — σκιά αληθινή.
 * Άρα #2009 και #1428 ΒΓΗΚΑΝ (το «μισό κύμα» τους ήταν ψεύτικος συναγερμός) και το +17 δεν μπαίνει.
 * Κέδρος #2189 / Βίντζι #1696 μένουν ώσπου να κριθούν: εκεί το όργανο δεν έχει ακόμα καθαρή μέρα
 * ανοιχτής θάλασσας που να δείχνει ότι βλέπει αφρό σε αυτή τη λωρίδα άμμου.
 * ΜΑΡΤΥΡΑΣ ΑΦΙΞΗΣ ΑΠΟ ΕΔΩ = παρατήρηση ΣΤΗΝ ΑΚΤΗ (Sentinel-2, κάμερα, άνθρωπος) — ΠΟΤΕ συμφωνία
 * μοντέλων κελιού. Πύλη: shore-shadow-contract Δ0 (καρφώνει και όσους βγήκαν).
 */
