...
// Drives the landing hero and the "seas today" panel from today's real national
// conditions. Starts (and stays, on failure) at a gentle calm — we never
// fabricate a rough sea or fake readings. One cached national read backs both
// surfaces.
