...
<footer class="meth">
  ...
  <span class="tag best">κατά προσέγγιση</span> Προβολές, χώρες, συσκευές, χρόνος: από <b>09/09/2026</b> γράφονται ατομικά (γράψιμο μόνο αν δεν πρόλαβε άλλος, αλλιώς ξαναδιάβασμα) — πριν από αυτή την ημερομηνία χάνονταν σε ταυτόχρονες επισκέψεις, μετρημένα <b>~25% της ημέρας</b>, οπότε οι παλιότερες μέρες υποεκτιμούν σε όλα αυτά. Ποτέ δεν φουσκώνουν.
