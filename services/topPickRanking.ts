...
export const bestShelteredRecommendationGroup = (
   ...
   * ομάδα του βάθρου ΞΕΚΙΝΑΕΙ από αυτές — «οι μπλε πρώτες», όχι «μόνο οι μπλε» (βίβλος §Γ11, ίδια
   * μέρα): οι κενές θέσεις γεμίζουν από την επόμενη ομάδα, δες τον κώδικα πιο κάτω. Ο φραγμός βαθμίδας μιλάει μόνο όταν το χρώμα δεν έχει
