 ...
 *
 * ⚠️ ΙΣΤΟΡΙΚΟ ΕΡΓΑΛΕΙΟ ΑΠΟ ΤΙΣ 29/08/2026 ΤΟ ΒΡΑΔΥ: η απόφαση ΠΑΡΘΗΚΕ (Μίλτος: «πάρτο πάνω
 * σου») και οι δύο προτάσεις ΜΠΗΚΑΝ στον κώδικα — το πάτωμα ζει πλέον ΜΕΣΑ στη
 * resolveShoreShadowDamping και το 'enclosed' μέσα στη resolveSeaArrivalExposureLevel, οπότε
 * το «τρέχον» που μετράει αυτό το σκριπτ τα περιέχει ήδη και το σκέλος (Α) θα δείξει ~0.
 * Τα νούμερα της απόφασης (17,1% / 2.463 παραλίες προς την προσοχή · 2,8% / 339 προς την
 * ηρεμία · 7/7 μάρτυρες) γράφτηκαν στο commit της 29/08. Η ζωντανή φύλαξη είναι πλέον δύο
 * πύλες: validateShoreShadowContract (το σχήμα) και validateShoreShadowWitnesses (οι κάμερες).
 *
