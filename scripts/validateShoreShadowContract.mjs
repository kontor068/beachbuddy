...
// Μουτσούνα #2009, Φράγκου #1428, Κέδρος #2189, Βίντζι #1696: ο Copernicus ΚΑΙ το ewam είδαν το κύμα να φτάνει από τη
...
const beforeWitness = failures.length;
{
  ...
  // +17 του δεύτερου κριτή (reports/quality/shadow-second-judge.json, 10/09).
  for (const pinned of [2009, 1428, 2189, 1696,
