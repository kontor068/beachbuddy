...
const checks = [
  ...
  },
  {
    ...
    description: 'Οδηγεί την πραγματική resolveShoreShadowDamping (σχήμα: διάδρομος→1, άκρη→0,5, e^(−θ/45°), δάπεδο 0,10, μονοτονία, κενά→undefined) και τη shoreSeaStateM (K_d ΜΟΝΟ στο protected σκέλος, φραγμένο [0,1], το grazing του §Γ59 κρατά το 0,5 του), καρφώνει τους 5 αριθμούς, ελέγχει στον πηγαίο κώδικα ότι scoring/ταβάνι/πόρτα-4Μπφ/αιτία/πινέζα διαβάζουν ΟΛΟΙ το score.shoreShadowDamping, και αποδεικνύει με κλήση ότι η πινέζα με K_d=1 δεν βγαίνει πιο ήρεμη από K_d=0,1.',
