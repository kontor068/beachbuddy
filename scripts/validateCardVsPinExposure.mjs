 ...
 * υπάρχει για την έκθεση. Πρέπει να είναι θάλασσα που δεν επιβάλλει από μόνη της ταβάνι.
 *
 * ⚠️ ΗΤΑΝ 0,40 ΚΑΙ ΕΠΕΣΕ ΣΤΟ 0,30 (21/08/2026). Το `IDEAL_MAX_SHORE_SEA_STATE_M` μπήκε εκείνη
 * τη μέρα ακριβώς στα 0,40: μια `partial` ακτή δεν παίρνει έκπτωση ακτής, οπότε διάβαζε 0,40 και
 * το δάπεδο άναβε, ενώ η `protected` διάβαζε 0,20 και έμενε μπλε. Η πύλη τύπωσε 60 «παραβιάσεις»
 * σε 59 παραλίες που ΔΕΝ ήταν διαφωνία έκθεσης — ήταν το fixture της να κάθεται πάνω στο νέο
 * κατώφλι. Η πρόθεση της σταθεράς δεν άλλαξε· άλλαξε το νούμερο που την κάνει αληθινή, και
 * κρατάει απόσταση από ΟΛΑ τα ταβάνια/δάπεδα του χρώματος (0,40 / 0,80 / 1,20) σε κάθε επίπεδο
 * έκθεσης. Αν προστεθεί ποτέ κανόνας κάτω από 0,30, αυτό το νούμερο ξαναπέφτει μαζί του.
 */
const NEUTRAL_SEA_M = 0.3;
