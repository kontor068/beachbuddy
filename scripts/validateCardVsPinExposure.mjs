 ...
 *
 * Άρα οι έξι από κάτω ΔΕΝ είναι ανοχή σφάλματος του χάρτη· είναι το ίχνος ενός ανοιχτού
 * σφάλματος της ΚΑΡΤΑΣ. Σβήνονται όταν διορθωθεί το authored προφίλ τους, όχι πριν.
 */
const KNOWN_COLOUR = new Map(Object.entries({
  1146: 'Άγιος Ιωάννης Λευκάδας — Α/ΝΑ/Ν/ΝΔ απόγειοι (onshore ως -0,98), η κάρτα τους λέει εκτεθειμένους',
  1976: 'Φτελιά Μυκόνου — Α/ΝΑ/Ν/ΝΔ απόγειοι (onshore ως -0,999)· kitesurf spot στον ΒΟΡΙΑ, όχι στον νότο',
  2006: 'Μικρή Βίγλα Νάξου — ΒΑ/Α/ΝΑ/Ν απόγειοι (onshore ως -0,999)',
  2158: 'Αποθήκες Τήνου — Α/ΝΑ/Ν/ΝΔ απόγειοι (onshore ως -0,998)',
  2166: 'Κολυμπήθρα Τήνου — ΝΑ/Ν/ΝΔ απόγειοι· ο Α τομέας της διορθώθηκε από τον φραγμό',
  2001: 'Λιγαρίδια Νάξου — Β απόγειος (onshore -0,46)',
}));
