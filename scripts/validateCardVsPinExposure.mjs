 ...
 *
 * Και δεν είναι μόνο οι απόγειοι τομείς: ο εξομαλυντής δανείζει προστασία και σε ΠΛΑΓΙΟΥΣ
 * (Φτελιά @Α onshore +0,04, Κολυμπήθρα @Α +0,32, Μικρή Βίγλα @ΒΑ -0,04) — εκεί που το μελτέμι
 * τρέχει παράλληλα στην ακτή. Ο φραγμός `takesTheWindHeadOn` του §Γ27β πιάνει το «κατάμουτρα»,
 * όχι το «παράλληλα». ΑΝΟΙΧΤΟ: θέλει δική του μέτρηση πριν αγγίξει κανείς εθνικό κανόνα χάρτη.
 */
const KNOWN_COLOUR = new Map(Object.entries({
  ...
  2006: 'Μικρή Βίγλα Νάξου — δανεικό protected σε Α/ΝΑ/Ν ΚΑΙ στον πλάγιο ΒΑ (onshore -0,04)',
  2158: 'Αποθήκες Τήνου — δανεικό protected σε Α/ΝΑ/Ν ΚΑΙ στον πλάγιο ΝΔ (onshore -0,07)',
  2166: 'Κολυμπήθρα Τήνου — δανεικό protected σε ΝΑ/Ν/ΝΔ ΚΑΙ στον πλάγιο Α (onshore +0,32)',
  2001: 'Λιγαρίδια Νάξου — Β απόγειος (onshore -0,46)· η κάρτα εδώ μένει exposed από authored λίστα',
}));
