...
/**
 * ΚΑΣΤΑΝΙΑ, ΟΧΙ ΣΤΟΧΟΣ. Μετρήθηκε 17/08/2026: 255 αναξιόπιστες σε 2.872 παραλίες.
 * Ο αριθμός επιτρέπεται να ΠΕΣΕΙ ελεύθερα. Αν ανέβει, κάτι χάλασε — είτε μια νέα παραλία μπήκε
 * σε κακό σημείο, είτε ένα rebuild μετακίνησε σημεία θάλασσας. Ανέβασε αυτό το νούμερο ΜΟΝΟ αν
 * η αύξηση εξηγείται και είναι αποδεκτή, και γράψε γιατί δίπλα στην αλλαγή.
 */
const UNTRUSTED_BASELINE = 255;
