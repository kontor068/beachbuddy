 ...
 *   3. Οι τρεις κανόνες τιμιότητας του seaSeasonProfile.mjs ισχύουν στην πράξη.
...
if (callSite) {
  check('περνάει ΤΑΥΤΟΤΗΤΕΣ παραλιών, όχι αντικείμενα',
    /\.map\(\s*beach\s*=>\s*beach\.id\s*\)/.test(callSite[1]),
