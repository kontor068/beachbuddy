...
//
// ⚠️ ΑΠΟ ΤΙΣ 22/08/2026 ΤΟ ΝΟΗΜΑ ΤΟΥΣ ΑΝΤΙΣΤΡΑΦΗΚΕ. Το παράθυρο A0 ΜΠΗΚΕ στην εφαρμογή
// (βίβλος §Γ59, utils/waveCharacter.SEA_ARRIVAL_GRAZING). Άρα το `before` αυτού του script
// ΗΔΗ κουβαλάει την έκπτωση, το `forceDiscount` δεν αλλάζει τίποτα, και ο μάρτυρας #680
// σκάει με «ΑΚΥΡΗ ΜΕΤΡΗΣΗ». Αυτό ΔΕΝ είναι σπασμένη καλωδίωση — είναι η απόδειξη ότι η
// αλλαγή προσγειώθηκε. Το script μένει ως ΙΣΤΟΡΙΚΟ όργανο: το `reports/weather/
// grazing-sea-impact-live.json` κρατάει τη μέτρηση ΠΡΙΝ, και από εκεί βγαίνουν τα νούμερα
// που δικαιολογούν την απόφαση. Για να μετρήσεις ξανά μελλοντικά παράθυρα (A3/B0/B3) πρέπει
// πρώτα να γυρίσεις πίσω το §Γ59, αλλιώς συγκρίνεις την αλλαγή με τον εαυτό της.
