...
const ALLOWED = [
  ...
  [': shoreWaveM < effectiveWaveHeightM', 1, 'το shoreWaveSource (06/09/2026): ρωτάει «ο τυπωμένος αριθμός ακτής διαφέρει από το ανοιχτό;» για να πει στο σχόλιο επισκέπτη από ποιον δρόμο βγήκε — δεν τυπώνεται, δεν χρωματίζει, δεν κρίνει'],
];
