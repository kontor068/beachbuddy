 ...
 *   (Α) ΟΡΙΖΟΝΤΑΣ — το ewam δίνει ύψος για ακριβώς 94 ώρες σε κάθε σημείο (μετρημένο σε 153
 *       σημεία, PORISMA §Γ43 — όχι ~82 όπως έλεγε η πρώτη εκτίμηση), η παραγωγή ζητάει 6 μέρες (144 ώρες).
 *   (Β) ΤΥΦΛΑ ΣΗΜΕΙΑ — κελιά μέσα σε κόλπους που το πλέγμα 0,05° του ewam δεν λύνει
 *       (το §Γ43 δεν τα αναπαρήγαγε πουθενά στο δείγμα των 153· μετριούνται ξανά εδώ, δεν υποτίθενται).
